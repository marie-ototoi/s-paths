...
class ListAllProps extends React.Component {
    constructor (props) {
        ...
        this.customState = {
            ...
            elementName: `refListAllPropsMap_${props.zone}`
        }
    ...
    render () {
        ...
        return (<div
            className = { `ListAllProps ${this.customState.elementName} role_${role}` }
        >
            { step !== 'changing' &&
            <div
                style = {{ 
    ...
    prepareData (nextProps) {
        ...
        const geodata = [{
            "name": "entities",
            "values": dataLib.prepareListAllPropsData(data, dataset),
            "format": {
                "type": "json",
                "property": "features"
            }
